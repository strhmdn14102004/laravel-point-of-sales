...
import { IconPencilPlus, IconPhoto, IconUpload, IconX, IconCheck, IconBarcode, IconCategory, IconCoin, IconStack } from '@tabler/icons-react'
...
export default function Create({ categories }) {
    ...
    const validateForm = () => {
        if (!data.image) {
            setImageError('Gambar produk wajib dipilih')
            return false
        }
        return true
    }
    ...
    const submit = (e) => {
        ...
        post(route('products.store'), {
            ...
            onError: () => {
                toast.error('Gagal menambahkan produk. Silakan cek kembali data Anda.', {
                    position: 'top-right',
                })
            },
        })
        ...
        <>
            ...
            <div className="space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-800 dark:text-white">Tambah Produk Baru</h1>
                        <p className="text-gray-600 dark:text-gray-400">Isi form berikut untuk menambahkan produk baru</p>
                    </div>
                </div>
                    ...
                    <form onSubmit={submit} className="p-6 space-y-6">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                Gambar Produk <span className="text-rose-500">*</span>
                            </label>
                            ...
                            {imageError && (
                                <p className="mt-2 text-sm text-rose-600 dark:text-rose-400">{imageError}</p>
                            )}
                            {errors.image && (
