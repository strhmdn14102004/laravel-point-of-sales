                ...
                <div className="relative w-full max-w-md mx-4 z-10">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
                        ...
                        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 p-6 text-center">
                            <div className="flex justify-center mb-4">
                                <ApplicationLogo className="w-16 h-16 text-white" />
                            </div>
                            <h1 className="text-2xl font-bold text-white">Aplikasi Kasir</h1>
                            <p className="text-blue-100 mt-1">Masuk untuk mengakses dashboard</p>
                        </div>
                        ...
                        <div className="p-8">
                            ...
                            <form onSubmit={submit} className="space-y-6">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    {canResetPassword && (
                                        <a href={route('password.request')} className="text-sm text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300">
                                            Lupa password?
                                        </a>
                                    )}
                                </div>
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                            Belum punya akun?{' '}
                            <a href={route('register')} className="font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300">
                                Daftar sekarang
                            </a>
                        </p>
                    </div>
